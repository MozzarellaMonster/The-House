...
class options:
    ...
    def foyer():
        ...
        print("swinging door that looks like it leads to a living room, to the right just before the stairs there")
        print("is another door that looks like it goes into an office, and lastly there is a dark hallway.")
        options.foyer_2()
